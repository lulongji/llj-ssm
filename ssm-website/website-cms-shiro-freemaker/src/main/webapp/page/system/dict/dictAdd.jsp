...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" id="saveDicForm" onkeypress="if(event.keyCode==13||event.which==13){return false;}" role="form" action="${ctx}/dict/saveDict.do">

				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" >字典名称</label>
					<div class="col-sm-3">
						<input id="dictName"  name="name" type="text" class="width-95" />
					</div>
					...
					<div class="col-sm-3">
						<select name="categoryId" id="categoryId" class="width-95">
							...
							<c:forEach items="${categoryList}" var="category" varStatus="stat">
								<option value="${category.id}-${category.categoryCode}">${category.categoryName}</option>
							</c:forEach >
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<span class="block input-icon input-icon-right">
							<input id="parentName" name="parentName" class="width-95" readonly type="text">
							<input type="hidden" id="parentId" name="parentId"/>
							<input type="hidden" id="parentDict" name="parentDict"/>
							<input type="hidden" id="dictLevel" name="dictLevel"/>
						</span>
					</div>
					<div class="col-sm-2 col-xs-20" style="margin-left: 0px;padding-left: 0px;" >
						<span class="block input-icon input-icon-right">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input id="dictCode"  name="dictCode" type="text" class="width-95" />
                    </div>
                    <div class="col-sm-2 col-xs-20" style="margin-left: 0px;padding-left: 0px;" >
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input id="dictContent"  name="dictContent" type="text" class="width-95" />
                    </div>
                    <div class="col-sm-2 col-xs-20" style="margin-left: 0px;padding-left: 0px;" >
                    </div>
                </div>
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
						<button id="saveDict" class="btn btn-info" type="button">
